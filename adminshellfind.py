...
def main():
	...
	print wait+"\n## ------ Welcome to Admin & Shell Finder Utility - Developed by nginxDEX (http://magelang1337.com) | Apache License V2.0 | Project Source (https://github.com/nginxdex/admin-shellfind) ------ ##"
